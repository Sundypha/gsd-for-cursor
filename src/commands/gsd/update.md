...
```bash
cat ~/.cursor/get-shit-done/VERSION 2>/dev/null
```
...
- `~/.cursor/commands/gsd/` will be wiped and replaced
- `~/.cursor/get-shit-done/` will be wiped and replaced
- `~/.cursor/agents/gsd-*` files will be replaced

Your custom files in other locations are preserved:
- Custom commands in `~/.cursor/commands/your-stuff/` ✓
