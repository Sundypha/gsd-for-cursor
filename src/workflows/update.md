...
if [ -f ./.cursor/get-shit-done/VERSION ]; then
  cat ./.cursor/get-shit-done/VERSION
  echo "LOCAL"
elif [ -f ~/.cursor/get-shit-done/VERSION ]; then
  cat ~/.cursor/get-shit-done/VERSION
  echo "GLOBAL"
else
  echo "UNKNOWN"
...
(Paths are relative to your install location: `~/.cursor/` for global, `./.cursor/` for local)
