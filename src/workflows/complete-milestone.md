...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node ~/.cursor/get-shit-done/bin/gsd-tools.cjs summary-extract "$summary" --fields one_liner | jq -r '.one_liner'
done
```
...
ask_question(header="Archive Phases", question="Archive phase directories to milestones/?", options: "Yes — move to milestones/v[X.Y]-phases/" | "Skip — keep phases in place")
...
ask_question with options: Squash merge (Recommended), Merge with history, Delete without merging, Keep branches.
