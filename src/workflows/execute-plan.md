...
```
If previous SUMMARY has unresolved "Issues Encountered" or "Next Phase Readiness" blockers: ask_question(header="Previous Issues", options: "Proceed anyway" | "Address first" | "Review previous").
</step>
