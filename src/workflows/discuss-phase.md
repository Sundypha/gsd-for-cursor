...
2. **Ask 4 questions using ask_question:**
   ...
   - options: 2-3 concrete choices (ask_question adds "Other" automatically), with the recommended choice highlighted and brief explanation why
...
```bash
node ~/.cursor/get-shit-done/bin/gsd-tools.cjs commit "docs(${padded_phase}): capture phase context" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
