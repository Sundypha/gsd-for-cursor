...
```bash
CHECKER_MODEL=$(node ~/.cursor/get-shit-done/bin/gsd-tools.cjs resolve-model gsd-integration-checker --raw)
```
...
for summary in .planning/phases/*-*/*-SUMMARY.md; do
  node ~/.cursor/get-shit-done/bin/gsd-tools.cjs summary-extract "$summary" --fields requirements_completed | jq -r '.requirements_completed'
done
```
